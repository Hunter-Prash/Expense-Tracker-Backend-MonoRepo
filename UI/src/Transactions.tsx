                    ...
                    <motion.div variants={container} initial="hidden" animate="show" className={`${glassStyle} rounded-3xl p-6 sm:p-8`}>
                        ...
                        {loadingTxns ? (
                            ...
                            <motion.div variants={item} className="rounded-2xl p-12 text-center border-dashed border-2 border-surface-lighter/50 mx-auto">
                                ...
                                <h4 className="text-xl font-bold text-text mb-2">No Transactions Today</h4>
                                <p className="text-text-muted max-w-md mx-auto">
                                    You haven't added any expenses or income today. Head back to the dashboard to log some!
                                </p>
                            </motion.div>
                        ) : (
                        ...
                        >
                            <div className={`w-full max-w-md ${glassStyle} rounded-2xl p-8`}>
                                ...
                                <form onSubmit={handleUpdateSubmit} className="space-y-5">
                                    ...
                                    <div>
                                        <label className="block text-sm font-bold text-text-muted mb-2">Amount (₹)</label>
                                        <input
                                    ...
                                    <button
                                        type="submit" disabled={submittingUpdate}
